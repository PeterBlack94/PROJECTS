...
bool CTicket::set_b_validity(int i_index, bool b_validity)
{ 
...
bool CTicket::get_b_validity(int i_index, bool& check)
{ 
	if (i_index > 6 || i_index < 0) return (check=false);
